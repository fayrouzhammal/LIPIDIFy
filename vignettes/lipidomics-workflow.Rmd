...
Imputing **after** normalisation ensures that imputed values sit on the same
scale as observed values, and that KNN imputation operates on data where
samples are already comparable.
...
For the remainder of this vignette we use the complete normalised data without
...
should be applied after normalisation and imputation, and verified with PCA.
